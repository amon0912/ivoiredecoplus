...
<div class="container mt-5">
    ...
    <form id="form" enctype="multipart/form-data" method="post">
        ...
        <div class="form-group m-2">
            ...
            <input id="Titre" class="form-control" type="text" name="titre" value="<?= (!empty($d['titre_deco']) ? $d['titre_deco'] : '') ?>">
        </div>
        ...
        <div class="form-group m-2">
            ...
            <textarea id="description" class="form-control" type="text" name="description"><?= (!empty($d['description_deco']) ? $d['description_deco'] : '') ?></textarea>
        </div>
