            ...
            foreach ($d as $key => $value) { ?>
                <div class="col-md-5 m-3">
                    <div class="row shadow-sm  h-100 w-100">
                        <div class="col-md-7">
                            <div class="rounded-0 card__image" style="height: 100px; width:100%">
                        ...
                        <div class="col-md-5">
                            ...
                            <p style="text-align:justify;">
                                <?= $value['prix_deco'].' Francs CFA' ?>
                            </p>
                            <p style="text-align:justify;">
                                <?= $value['description_deco'] ?>
                            </p>
                            <a style="background: #370d05;" class="btn text-decoration-none btn-dark m-1" href="?p=contactez-nous">Nous contactez</a>
                        </div>
                    </div>
                </div>
            <?php } ?>
